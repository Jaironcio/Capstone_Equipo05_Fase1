...
class SistemaBomberos {
    ...
    async init() {
        ...
        this.renderizarBomberos(); // Renderizar DESPUÉS de cargar todo
...
renderizarBomberos() {
    ...
    // TEMPORAL: Habilitar todos los botones para testing
    const permisos = {
        canEdit: true,
        canDelete: true,
        canViewCargos: true,
    ...
    const puedeVerCargos = true;
    const puedeVerSanciones = true;
