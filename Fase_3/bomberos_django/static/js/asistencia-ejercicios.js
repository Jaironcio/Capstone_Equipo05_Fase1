// ==================== SISTEMA DE ASISTENCIA A EJERCICIOS ====================
class SistemaEjercicios extends SistemaAsistencias {
    constructor() {
        super();
        this.tipoAsistencia = 'ejercicios';
        this.nombreClase = 'ejerciciosSistema';
    ...
    async init() {
        ...
        document.getElementById('fechaEjercicio').value = new Date().toISOString().split('T')[0];
    ...
    async guardarAsistencia() {
        try {
            ...
            if (!fecha) {
                Utils.mostrarNotificacion('Debe ingresar la fecha del ejercicio', 'error');
                return;
            }
            ...
            if (!tipoEjercicio) {
                Utils.mostrarNotificacion('Debe seleccionar el tipo de ejercicio', 'error');
                return;
            }
            ...
            // Actualizar ranking
            this.actualizarRankingAsistencias(asistentes, 'ejercicios');

            // Mensaje detallado con resumen
            const tipoTexto = tipoEjercicio === 'compañia' ? 'Ejercicio de Compañía' : 'Ejercicio del Cuerpo de Bomberos';
            let mensaje = `✅ ${tipoTexto} registrado exitosamente\n\n` +
            ...
            alert(mensaje);
            Utils.mostrarNotificacion('✅ Asistencia guardada exitosamente', 'success');
...
const ejerciciosSistema = new SistemaEjercicios();
document.addEventListener('DOMContentLoaded', () => {
    ejerciciosSistema.init();
});
